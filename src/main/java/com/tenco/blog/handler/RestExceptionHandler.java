...
//			
//			ExceptionFieldMessage exceptionFieldMessage = ExceptionFieldMessage.builder()
//			.field(fieldName)
...
//	}
	...
	public ApiErrorResponse methodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		return ApiErrorResponse.builder().statusCode(HttpStatus.BAD_REQUEST.value())
				.code("-1")
				.resultCode("fail")
				.message("잘못된 요청입니다")
				.exceptionFieldMessages(errorList).build();
	}
}
